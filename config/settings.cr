...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Chess Accuracy web application."
  #
  #
  ...
  #
  # settings.secret_key_base= QhCYRCgwIMJ2LVibrMQ62oM_n3kbe461owEwV3GknZc
  #
  #
  ...
  settings.secrets["auth_headers"] = ENV["AUTH_HEADERS"] if ENV["AUTH_HEADERS"]?
end
